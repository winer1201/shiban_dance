define(['zepto'], function ($) {
    ...
    Dialog.prototype = {
        ...
        create: function () {
            ...
            var divHeader = (!this.settings.title) ? '' : '<div class="rDialog-header-' + this.settings.title + '"></div>';

            // HTML模板
            var templates = '<div class="rDialog-wrap">' +
                                divHeader +
                                '<div class="rDialog-content">' + this.settings.content + '</div><hr class="rDialog-hr" />' +
    ...
    tdialog.showDialog = function (options) {
